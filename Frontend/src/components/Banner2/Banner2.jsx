            ...
            <div className="space-y-5 sm:p-16 pb-6">
              <div data-aos="zoom-in" className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h1 className="text-2xl sm:text-4xl font-bold">Why you should choose us?</h1>
                </div>
              </div>
              <p data-aos="fade-up" className="leading-8 tracking-wide">
                We are highly disciplined group of people who are always striving for growth.
              </p>
              <p data-aos="fade-up" data-aos-delay="300">
               We work for the betterment of our coustmers and for their betterment.
              </p>
